...
export default function Speech_to_txt() {
  ...
  // Close the SpeechToTextToSpeech component when clicking outside
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (voiceUIRef.current && !voiceUIRef.current.contains(event.target)) {
      ...
      <div className="w-full max-w-6xl bg-[#1a1a1a] rounded-xl shadow-lg flex flex-col h-[90vh]">
        ...
        <div className="p-4 bg-[#1a1a1a] rounded-t-xl border-b border-[#2a2a2a]">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="font-semibold text-[#ffffff]">Chat</h1>
          </div>
        </div>
